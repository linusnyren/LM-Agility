...
function () {
  function ICalEvent(data, _calendar) {
    ...
    this._attributes = ['id', 'uid', 'sequence', 'start', 'end', 'timezone', 'stamp', 'timestamp', 'allDay', 'floating', 'repeating', 'summary', 'location', 'geo', 'description', 'htmlDescription', 'organizer', 'attendees', 'alarms', 'categories', 'status', 'busystatus', 'url', 'created', 'lastModified', 'recurrenceId'];
    this._vars = {
  ...
  _createClass(ICalEvent, [{
    ...
    value: function repeating(_repeating) {
      ...
      if (_repeating.bySetPos) {
        ...
        c._data.repeating.byDay = [_repeating.byDay[0]];
